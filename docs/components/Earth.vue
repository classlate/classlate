 ...
 * https://github.com/pangyongsheng/-visualization/blob/master/src/views/webgl/t4.vue
-->
<script lang="ts">
...
export default {
  ...
  methods: {
    ...
    //   const v0 = this.getPosition(longitude, latitude, this.radius)
    //   const v3 = this.getPosition(longitude2, latitude2, this.radius)
    ...
    //   // 生成一个时间序列
    //   const times = Array.from(new Float32Array(arr)) as any[]
    ...
    //   })
    //   // 创建一个和时间序列相对应的位置坐标系列
    //   const values = Array.from(new Float32Array(posArr)) as any[]
    ...
    //   // 顶点坐标
    //   const vtop = rayLine.at(hLen / rayLine.at(1, new THREE.Vector3(10, 0, 10)).distanceTo(p0), new THREE.Vector3(0, 10, 0)) // 几倍位置
    //   // 控制点坐标
    ...
    //   const arc = new THREE.ArcCurve(0, 0, r, 0, 2 * Math.PI, false)
